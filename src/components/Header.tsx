    ...
    <header className="sticky top-0 z-50 backdrop-blur-xl bg-primary-deep text-primary-foreground border-b border-white/10">
      <div className="container flex items-center justify-between py-3">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm font-medium">
          <a href="#products" className="hover:text-accent transition-smooth">Продукция</a>
          <a href="#calculator" className="hover:text-accent transition-smooth">Калькулятор</a>
          <a href="#advantages" className="hover:text-accent transition-smooth">О нас</a>
